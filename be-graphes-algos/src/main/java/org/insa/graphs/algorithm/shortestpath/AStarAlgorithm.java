...
public class AStarAlgorithm extends DijkstraAlgorithm {
    ...
    protected Label[] labels_init() {
       LabelStar labels[] = new LabelStar[nb_Nodes] ;
       ...
       Point point_destination = ((ShortestPathData)data).getDestination().getPoint();
    ...
    private int Speed() {
       ...
       int maxspeed_graphe = graph.getGraphInformation().getMaximumSpeed() ;
